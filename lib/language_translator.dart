...
class LanguageTranlationPage extends StatefulWidget {
  ...
  @override
  State<LanguageTranlationPage> createState() => _LanguageTranlationPageState();
}

class _LanguageTranlationPageState extends State<LanguageTranlationPage> {
  var languages = ['English', 'Kyrgyz', 'German'];
